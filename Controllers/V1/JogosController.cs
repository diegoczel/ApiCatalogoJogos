...
namespace ApiCatalogoJogos
{
    ...
    {
        // readonly pois a instanciação é de responsabilidade do ASP.NET
        ...
        public async Task<ActionResult<IEnumerable<JogoViewModel>>> Obter(
            // FromQuery define que arg irá vir da url da requisição e o 
            // Range deve ser entre 1 e int.MaxValue
            [FromQuery, Range(1, int.MaxValue)] int pagina = 1, 
            [FromQuery, Range(1, 50)] int quantidade = 5)
        {
            // get all Jogos

            // await _jogoService.Obter(1, 5) o retorno é List<JogoViewModel>
            // _jogoService.Obter(1, 5) o retorno é Task<List<JogoViewModel>>
        ...
        {
            // FromRoute vem da rota like api/123
            // FromQuery vem da url liker api/?id=123
        ...
        {
            // post one Jogo and return this Jogo
            try
            {
        ...
        public async Task<ActionResult> AtualizarJogo(
            [FromRoute] Guid idJogo, [FromBody] JogoInputModel jogoInputModel)
        {
            // put atualiza todo o object de uma vez
            try
            {
        ...
        {
            // patch atualiza somente um recurso do object
